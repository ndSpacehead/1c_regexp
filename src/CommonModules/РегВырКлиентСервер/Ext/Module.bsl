	...
	Для я = 0 По М-1 Цикл
		...
		ИначеЕсли Символ = ")" Тогда
			...
			Пока НачальныйСимвол <> "(" Цикл
	            ...
	            ор = ИзъятьИзСтека(Стек);
				НачальныйСимвол = Сред(Шаблон, ор+1, 1);
				Если НачальныйСимвол = "|" Тогда
					ИндексыОператоровИЛИ.Добавить(ор);
	            ИначеЕсли НачальныйСимвол = "(" Тогда
	                lp = ор;
					Для Каждого Индекс Из ИндексыОператоровИЛИ Цикл
						ДобавитьНаправлениеВОрграф(Орграф, lp, Индекс+1);
		...
		Если я < М-1 Тогда
			...
			Если СледующийСимвол = "*" Тогда
				ДобавитьНаправлениеВОрграф(Орграф, lp, я+1);
				ДобавитьНаправлениеВОрграф(Орграф, я+1, lp);
			КонецЕсли;
        КонецЕсли;
