...
Функция ЭкранированияСимволов() Экспорт
	...
	Для Каждого КЗ Из РегуляркаПовтИсп.Метасимволы() Цикл
...
Функция ЭкранированияСимволовВКлассе() Экспорт
	фРезультат = Новый Соответствие(РегуляркаПовтИсп.ЭкранированияСимволов());
	фРезультат.Удалить(".");
...
Функция ТокеныКлассаСимволовСлов(Знач Отрицание = Ложь)
	...
	Токен = НовыйТокен(РегуляркаПовтИсп.ТипТокенаКлассСимволов(), НовыеДанныеТокенаКлассаСимволов(Отрицание));
